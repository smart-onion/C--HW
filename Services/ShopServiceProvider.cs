...
{
    public class ShopServiceProvider : IMyServiceProvider
    {
        IDataProvider _context;

        public ShopServiceProvider(IDataProvider context) { _context = context; }
